package com.fafik.fafikpetclinic.controllers;
...
import com.fafik.fafikpetclinic.services.PetService;
...
class VisitControllerTest {
    ...
    public static final String YET_ANOTHER_VISIT_DESCRIPTION="yet another visit description";
    ...
    void setUp() {
        ...
        when(petService.findById(anyLong()))
                .thenReturn(Pet.builder()
                                .id(petId)
                                .birthDate(LocalDate.of(2019,07,20))
                                .name("Fafik")
                                .visits(new HashSet<>())
                                .owner(Owner.builder()
                                        .id(ownerId)
